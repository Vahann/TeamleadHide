  ...
  const ssrEngine = function (viewFile, options, callback) {
    ...
    try {
      ...
      const viewOptions = {
        ...
        reactSource: `//unpkg.com/react@18/umd/react.${devEnv ? 'development' : 'production.min'}.js`,
        reactDomSource: `//unpkg.com/react-dom@18/umd/react-dom.${devEnv ? 'development' : 'production.min'}.js`,
